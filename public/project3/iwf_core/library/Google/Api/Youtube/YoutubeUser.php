 ...
 * @see        AdsUser
 */
require_once dirname(__FILE__) . '/../Ads/Common/Lib/AdsUser.php';
require_once dirname(__FILE__) . '/../Ads/Common/Util/ApiPropertiesUtils.php';
require_once dirname(__FILE__) . '/../Ads/Common/Util/AuthToken.php';
require_once dirname(__FILE__) . '/../Ads/Common/Util/DeprecationUtils.php';
require_once dirname(__FILE__) . '/../Ads/AdWords/Util/ReportUtils.php';
require_once dirname(__FILE__) . '/../Ads/AdWords/Lib/AdWordsSoapClientFactory.php';
require_once dirname(__FILE__) . '/../Ads/AdWords/Lib/AdWordsConstants.php';
 ...
 * @subpackage Lib
 */
class YoutubeUser extends AdsUser {
  ...
  public function __construct($authenticationIniPath = NULL, $email = NULL,
    ...
    $buildIniAw = parse_ini_file(dirname(__FILE__) . '/../Ads/AdWords/Lib/build.ini',
        FALSE);
    $buildIniCommon = parse_ini_file(dirname(__FILE__) .
        '/../Ads/Common/Lib/build.ini', false);
    ...
    $apiProps = ApiPropertiesUtils::ParseApiPropertiesFile(dirname(__FILE__) .
        '/../Ads/AdWords/Lib/api.properties');
    ...
    if (isset($authenticationIniPath)) {
      ...
      $authenticationIni =
          parse_ini_file(dirname(__FILE__) . './Ads/AdWords/auth.ini', TRUE);
    }
    ...
    if (!isset($settingsIniPath)) {
      $settingsIniPath = dirname(__FILE__) . '/../Ads/AdWords/settings.ini';
    }
