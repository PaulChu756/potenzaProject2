...
class Ia_Form_Element_EntityMultiSelect extends Zend_Form_Element_Multiselect
{
     ...
     * We set this to fault because inactive or even deleted records may be included
     * @var bool
     */
