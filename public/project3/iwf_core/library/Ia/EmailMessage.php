...
class EmailMessage
{
    ...
    const SEPARATOR_TEXT = ':: Reply above this line to post your response ::';
    
    public function __construct($imap, $message, $file_destination=null)
    {
        $this->file_destination = ($file_destination===null) ? sys_get_temp_dir() : $file_destination;
        $this->imap = $imap;
    ...
    private function decode($partNumber, $part)
    {
        ...
        if($params['filename'] || $params['name'])
        {
            ...
            file_put_contents($this->file_destination.DIRECTORY_SEPARATOR.$destination, $data);
        }
