...
class Ia_UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $url = ($front->getRequest()->isSecure()) ? 'https://' : 'http://';
        $url .= $front->getRequest()->getHttpHost();

        $upload_url = $url.'/uploads/files';
        $script_url = $url.$front->getParam('bootstrap')->getResource('view')->url(array('module'=>'default','controller'=>'asset','action'=>'upload'));

        $this->options = array(
            'script_url' => $script_url,
            'upload_dir' => PUBLIC_PATH.DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR.'files',
    ...
    public function move_uploaded_file($file, $destination)
    {
        ...
        $finalDestination = $destination.DIRECTORY_SEPARATOR.$file->name;
        rename($this->get_upload_path($file->name),$finalDestination);
