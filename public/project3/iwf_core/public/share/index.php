...
defined('APPLICATION_PATH')
    || define('APPLICATION_PATH', realpath(dirname('_env.php') . '/../application'));
    
// Define path to application directory
defined('PUBLIC_PATH')
    || define('PUBLIC_PATH', realpath(dirname('_env.php') . '/../public'));
...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd", ".gitignore");
